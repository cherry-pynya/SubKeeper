...
- [X] Написать комментарии
- [ ] Задеплоить
- [X] Сделать dashboard
- [X] Сделать таблички с пояснениями
- [ ] сделать шифрование
- [X] Сделать стилизованную кнопку google
- [X] Расширить окно диаграммы на мобильных
- [X] добавить описание в "о проекте"

Библиотеки: moment.js, google piecharts, Material UI, Bootstrap, 